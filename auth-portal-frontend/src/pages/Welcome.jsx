        ...
        <div className="flex min-h-screen bg-gradient-to-br from-slate-50 to-violet-50/30 text-slate-800">
            ...
            <div className="flex-1 flex flex-col min-h-screen overflow-y-auto pl-16 md:pl-0">
                <main className="max-w-6xl w-full mx-auto px-6 py-10">
                    ...
                    <div className="mb-10 p-8 rounded-3xl bg-gradient-to-r from-violet-600 to-indigo-600 text-white shadow-xl relative overflow-hidden">
                        <div className="absolute top-[-20%] right-[-10%] w-[40%] h-[150%] bg-white/10 rounded-full filter blur-2xl transform rotate-45 pointer-events-none"></div>
                        <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            ...
                            <span className="px-4 py-1.5 bg-white/20 backdrop-blur-md text-white font-bold text-xs rounded-full uppercase tracking-wider border border-white/10">
                                Role: {user?.role}
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                        ...
                        {isModerator && (
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2.5 bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl text-sm transition-all duration-200 shadow-md hover:shadow-lg"
                            >
                                                    ...
                                                    <div className="flex items-center justify-end gap-2.5">
                                                        ...
                                                        {((isAdmin && u.role !== 'admin') || (isModerator && u.role === 'user')) && u.id !== user?.id && (
                                                            <select
                                                                ...
                                                                className="px-2.5 py-1.5 border border-slate-200 rounded-xl text-xs bg-slate-50 hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-500/20 font-semibold"
                                                            >
                        ...
                        <form onSubmit={handleAddUserSubmit} className="flex flex-col gap-4">
                            ...
                            <div className="flex justify-end gap-3 mt-4">
                                <button
                                    ...
                                    className="px-4 py-2 bg-slate-100 hover:bg-slate-200 rounded-xl text-sm font-semibold text-slate-600 transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                                    type="submit"
                                    disabled={actionLoading}
                                    className="px-5 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-xl text-sm font-semibold transition-colors shadow-md disabled:opacity-50"
                                >
